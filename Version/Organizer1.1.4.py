...
#       menubar
        ...
        #editmenu.add_command(label="Recortar Imagen",command=self.crop_image)
        helpmenu = Menu(menubar, tearoff=0)
        helpmenu.add_command(label="Informacion de la imagen",command=self.info_tab)
...
#       configuraciones de la GUI
    ...
    def load_folders(self,dir_path):
       ...
       #new_button=tkinter.Button(self.button_frame,text="Create Folder",bg="#00ff00",fg="#ffffff",width=26,height=1,command=lambda: self.create_folder())
    ...
    def create_folder(self):
        new_folder = tkinter.Toplevel(self)
        new_folder.wm_title("Create a new folder")
        create_folder_button=tkinter.Button(new_folder,text="Create Folder",bg="#00ff00",fg="#ffffff",width=26,height=1,command=lambda: print("button clicked!!"))
        create_folder_button.place(x=40,y=380)
        new_folder.geometry(f"800x400")
